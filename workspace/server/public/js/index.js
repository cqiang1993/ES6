	  ...
	  _createClass(Base, [{
	    ...
	    value: function initPlayList() {
	      this.play_list.set('r2', {
	        ...
	        bonus: 26,
	        tip: '从01~11中任选7个或多个号码，选号与奖号五个号码相同，即中奖<em class="red">26</em>元',
	        name: '任七'
	      }).set('r8', {
	        bonus: 9,
	        tip: '从01~11中任选8个或多个号码，选号与奖号五个号码相同，即中奖<em class="red">9</em>元',
	        name: '任八'
	      });
	    }
	    /**
	    ...
	    value: function addCode() {
	      var self = this;
	      var $active = (0, _jquery2.default)('.btn-list .btn-boll-active').text().match(/\d{2}/g);
	    ...
	    value: function getCount() {
	      ...
	      if (count === 0) {
	        tpl = '\u4F60\u9009\u4E86 <b class="red">' + count + '</b> \u6CE8\uFF0C\u5171 <b class="red">' + count * 2 + '</b> \u5143';
	      } else if (range[0] === range[1]) {
	        tpl = '\u4F60\u9009\u4E86 <b class="red">' + count + '</b> \u6CE8\uFF0C\u5171 <b class="red">' + count * 2 + '</b> \u5143  <em>\u82E5\u4E2D\u5956\uFF0C\u5956\u91D1\uFF1A\n      <strong class="red">' + range[0] + '</strong> \u5143\uFF0C\n      \u60A8\u5C06' + (win1 >= 0 ? '盈利' : '亏损') + '\n      <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + Math.abs(win1) + '</strong> \u5143 </em>';
	      } else {
	    ...
	    value: function getRandom(num) {
	      ...
	      while (num--) {
	        index = Number.parseInt(Math.random() * number.lenth);
